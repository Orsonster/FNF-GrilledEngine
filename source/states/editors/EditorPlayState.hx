...
class EditorPlayState extends MusicBeatSubstate
{
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var pixelCrapPart1:String = "";
		var pixelCrapPart2:String = '';

		rating.loadGraphic(Paths.image(pixelCrapPart1 + daRating.image + pixelCrapPart2));
		rating.screenCenter();
		...
		var comboSpr:FlxSprite = new FlxSprite().loadGraphic(Paths.image(pixelCrapPart1 + 'combo' + pixelCrapPart2));
		...
		{
			var numScore:FlxSprite = new FlxSprite().loadGraphic(Paths.image(pixelCrapPart1 + 'num' + Std.int(i) + pixelCrapPart2));
	...
	function fullComboUpdate()
	{
		...
		var craps:Int = ratingsData[3].hits;

		ratingFC = 'Clear';
		if(songMisses < 1)
		{
			if (bads > 0 || craps > 0) ratingFC = 'FC';
