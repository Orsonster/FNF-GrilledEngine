...
class LuaUtils
{
	public static final Function_Stop:Dynamic = "##grilledlua_FUNCTIONSTOP";
	public static final Function_Continue:Dynamic = "##grilledlua_FUNCTIONCONTINUE";
	public static final Function_StopLua:Dynamic = "##grilledlua_FUNCTIONSTOPLUA";
	public static final Function_StopHScript:Dynamic = "##grilledlua_FUNCTIONSTOPHSCRIPT";
	public static final Function_StopAll:Dynamic = "##grilledlua_FUNCTIONSTOPALL";
	...
	public static function tweenPrepare(tag:String, vars:String) {
		...
		var tempyProp:Dynamic = LuaUtils.getObjectDirectly(variables[0]);
		if(variables.length > 1) tempyProp = LuaUtils.getVarInArray(LuaUtils.getPropertyLoop(variables), variables[variables.length-1]);
		return tempyProp;
	}
