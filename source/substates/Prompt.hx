...
class Prompt extends MusicBeatSubstate
{
	...
	override public function create():Void 
	{
		...
		add(buttonNo);
		//add(buttons);
		var textCrap:FlxText = new FlxText(buttonNo.width*2, panel.y, 300, theText, 16);
		textCrap.alignment = 'center';
		add(textCrap);
		textCrap.screenCenter();
	...
	*/
	...
	function makeSelectorGraphic(panel:FlxSprite,w,h,color:FlxColor)
	{
		...
		// also i wanted to understand better how fillRect works so i did this crap lol???
